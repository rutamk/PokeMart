          ...
          cartItems.map((item) => (
            <div key={item.name} className="flex justify-between items-center bg-neutral-800 px-3 py-2 rounded-md text-neutral-100">
              <div className="flex-1">
                ...
                {/* Quantity and Total in the same line */}
                <div className="flex justify-between items-center mt-1 ml-2 mb-2">
                  ...
                  <p className="text-lg font-semibold my-2">Total: ${item.price * item.quantity}</p>
                </div>
              </div>
            </div>
          ))
